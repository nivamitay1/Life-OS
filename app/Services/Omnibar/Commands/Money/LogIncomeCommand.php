...
class LogIncomeCommand implements OmnibarCommand
{
    ...
    public function handle(User $user, array $matches): OmnibarResult
    {
        ...
        return new OmnibarResult(
            ...
            detail: 'Logged Income: $' . $amount . ' from ' . $desc,
        );
    }
}
